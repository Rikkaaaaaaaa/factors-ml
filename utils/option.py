...
def parse_options(root_path, ensure=True):
    ...
    parser.add_argument('-option', type=str, default='option/ddb_null_factor_new_open/ddb_null_factor_new_open_hs300_highprice_lgbm_300s.yaml', help='Path to option YAML file.')
