...
def parse_options(root_path, ensure=True):
    ...
    parser.add_argument('-option', type=str, default='option/prod_train/prod_ddb_null_factor_no_reverse_hs300_highprice_lgbm_15s.yaml', help='Path to option YAML file.')
