...
def train_pipeline(train_args):
    ...
    dataset.train_data.to_parquet(f'./gen_data/train_data_indus{indus_type}_{test_month}_{opt["dataset"]["ret_name"]}.parquet')
    dataset.test_data.to_parquet(f'./gen_data/test_data_indus{indus_type}_{test_month}_{opt["dataset"]["ret_name"]}.parquet')
