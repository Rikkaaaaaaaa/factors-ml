...
def push_realtime_files(root_path='experiments', exp_name="ddb_factor_hs300_highprice_lgbm" ,res_name='lgbm_data', res_folder_path='./', test_month=202307):
    pool_name = 'hs300'
    ...
    print(f"Packaging all model files for {test_month}...")
    ...
    # save factor names
    save_path = osp.join(res_folder_path, "data/static_data")
