...
ofl_factor = ['ask1_ofl_std_3s', 'ask1_ofl_std_15s', 'ask1_ofl_std_min', 'ask1_ofl_std_2min', 'ask1_ofl_std_5min',
                 ...
                 'spread_tick_min', 'spread_tick_2min', 'spread_tick_5min', 'ask_wap_versus_mid_3s', 'bid_wap_versus_mid_3s',
                ]


ofl_factor_std = ['ask_wap_versus_mid_3s', 'bid_wap_versus_mid_3s']
...
ddb_ofl_factor = ["ask1_ofl_std_3s", "ask1_ofl_std_15s", "ask1_ofl_std_min", "ask1_ofl_std_2min", "ask1_ofl_std_5min",
                    ...
                    "ask_wap_versus_mid_3s",
                    "bid_wap_versus_mid_3s"
                    ]

ddb_base_factor = ['bulk_buy_sell_diff_15s', 'indus_active_buy_sell_diff_30s', 'order_diff_10_15s',
               'net_bid_amt_delta_60s', 'bulk_active_buy_sell_diff_60s',
               'net_bid_amt_delta_30s', 'indus_lower_ask_amt_60s', 'active_buy_sell_diff_15s',
               'mkt_bulk_active_buy_sell_diff_15s', 'net_bid_amt_delta_15s', 'indus_higher_bid_amt_30s',
               'indus_order_diff_1_15s', 'book_pressure_15s',
               'indus_net_bid_amt_delta_30s', 'lower_ask_amt_60s', 'mkt_book_pressure_15s',
               'bulk_active_buy_sell_diff_30s', 'mkt_net_bid_amt_delta_15s',
               'indus_bulk_active_buy_sell_diff_15s', 'higher_bid_amt_60s', 'book_pressure_delta_15s',
               'indus_lower_ask_amt_30s',
               'indus_bulk_active_buy_sell_diff_60s', 'indus_order_diff_10_15s',
               'active_buy_sell_diff_30s', 'book_pressure_30s', 'mkt_lower_ask_amt_15s',
               'indus_active_buy_sell_diff_15s', 'indus_bulk_active_buy_sell_diff_30s', 'indus_net_bid_amt_delta_60s',
               'lower_ask_amt_15s', 'bulk_buy_sell_diff_60s', 'bulk_active_buy_sell_diff_15s',
               'indus_cancel_diff_10_15s', 'indus_book_pressure_15s', 'mkt_active_buy_sell_diff_15s',
               'mid_mmt_route_5_5', 'bulk_buy_sell_diff_30s', 'mkt_higher_bid_amt_15s',
               'indus_net_bid_amt_delta_15s', 'order_diff_1_15s', 'mid_mmt_route_10_10',
               'indus_higher_bid_amt_60s', 'indus_book_pressure_delta_15s', 'higher_bid_amt_30s',
               'mkt_order_diff_10_15s', 'indus_lower_ask_amt_15s',
               'lower_ask_amt_30s',  'higher_bid_amt_15s', 'indus_higher_bid_amt_15s',
               'cancel_diff_10_15s'
               ]


ddb_base_factor_ret = ['ma_close_ret_10', 'ma_close_ret_5', 'ma_mid_ret_2_10', 'mid_ret_15s',
               'indus_mid_ret_30s', 'mid_ret_30s', 'close_ret_30s', 'indus_close_ret_30s',
               'ma_close_ret_1', 'ma_close_ret_2_10', 'indus_close_ret_60s', 'close_ret_15s',
               'indus_mid_ret_60s', 'indus_close_ret_15s', 'ma_mid_ret_2_5',
               'indus_mid_ret_15s', 'mid_ret_60s', 'ma_close_ret_2','mkt_close_ret_15s',
               'ma_mid_ret_2', 'ma_mid_ret_5', 'close_ret_60s', 'ma_close_ret_2_5',
               'ma_mid_ret_10',  'mid_ret_skew_10', 'ma_mid_ret_1'
               ]

ddb_gp_factor = [ "gp_1", "gp_2", "gp_3", "gp_4", "gp_5", "gp_6", "gp_7", "gp_8", "gp_9", "gp_10", "gp_11", "gp_12",
               "gp_13", "gp_14", "gp_16", "gp_17", "gp_19", "gp_20", "gp_25", "gp_26", "gp_27", "gp_28", "gp_29", "gp_30",
...
ddb_slope_std_factor = ['slope_ask3_3s', 'slope_ask3_15s', 'slope_ask3_min',
                    'slope_ask3_2min', 'slope_ask3_5min', 'slope_bid3_3s', 'slope_bid3_15s', 'slope_bid3_min',
                    'slope_bid3_2min', 'slope_bid3_5min', 'slope_diff3_3s', 'slope_diff3_15s', 'slope_diff3_min',
                    'slope_diff3_2min', 'slope_diff3_5min', 'slope_ask10_3s', 'slope_ask10_15s', 'slope_ask10_min',
                    'slope_ask10_2min', 'slope_ask10_5min', 'slope_bid10_15s', 'slope_bid10_3s', 'slope_bid10_min',
...
def build_factor_name_low_price(name):
    factor_name = []
