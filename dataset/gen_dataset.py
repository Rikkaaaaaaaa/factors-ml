...
class GenDataset():
    ...
    def load_data(self):
        ...
        self.logger.info(f"{self.test_month}_indus_{self.indus_type}: Avg test data num is {len(test_data)/len(self.tickers)} / per ticker ")
    ...
    def make_label(self, train_data, test_data):
        ...
        train_num = train_data['class_label'].value_counts()
        self.logger.info(f"{self.test_month}_indus_{self.indus_type}: Train label number is {train_num}")


        add_label(test_data)
        test_num = test_data['class_label'].value_counts()
        self.logger.info(f"{self.test_month}_indus_{self.indus_type}: Train label number is {test_num}")
