...
from dataset import batch2_factor_list
...
class FactorDataset2():
    ...
    def load_ticker_list(self):
        ...
        for pool in self.pool_name:
            ...
            factor = cx_read_sql('select distinct ticker from all_factor_{}'.format(self.test_month),
                                 database=self.database)
            self.tickers = list(factor['ticker'])
    ...
    def transform(self, train_data, test_data=None):
        ...
        factor_names = batch2_factor_list  # list(set(_train_data.columns) - set(del_column))
        ...
        for ticker in self.tickers:
            ...
            self.test_data.loc[_test_data.index, batch2_factor_list] = test_x
    ...
    def rebalance_training_data(self):
        ...
        if self.class_num == 2 and self.opt['dataset']['balance'] == 'reverse':
            ...
            train_data_copy[batch2_factor_list] = -1 * train_data_copy[batch2_factor_list]
